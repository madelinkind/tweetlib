...
#dame la instancia padre e invocale el constructor con estos parametros
    def __init__(self, count_tweets_x_user: int):
        super(DataSetPoliticos, self).__init__(TypeDataSet.politico, count_tweets_x_user)
