...
# 3. DataSet: DataSetPoliticos()
# 4. Classifier: Classification()
#-----------------------------------------------------------------------------------------
def politic_bert_within_prep():
    ...
    pipeline = TwitterPipeline(config, data_set, classifier, type_task)
...
def politic_bert_token_stopword_lowercase_lemma():
    config = Configuration([
        Preprocessing.FIX_HASHTAG_TEXT, 
...
def politic_bert_rm_alphanumeric():
    config = Configuration([
        Preprocessing.REMOVE_ALPHA_NUMERIC
    ], 
    EncodingMethod.BERT,
...
def politic_bert_emoji_link_num_punct():
    config = Configuration([
...
# 1. Config:
        ...
        #Classifier: BERT
# 2. type_task: VALIDATE_MODEL
# 3. DataSet: DataSetArtistas()
# 4. Classifier: Classification()
#-----------------------------------------------------------------------------------------
def artist_bert_within_prep():
    config = Configuration([
        ], 
        EncodingMethod.BERT,
        ClassificationMethod.BERT,
...
def artist_bert_token_stopword_lowercase_lemma():
    config = Configuration([
        Preprocessing.FIX_HASHTAG_TEXT, 
        Preprocessing.REMOVE_STOP_WORDS,
        Preprocessing.LOWERCASE,
...
def artist_bert_rm_alphanumeric():
    config = Configuration([
        Preprocessing.REMOVE_ALPHA_NUMERIC
    ], 
    EncodingMethod.BERT,
...
def artist_bert_emoji_link_num_punct():
    config = Configuration([
        Preprocessing.EMOTICONS,
        Preprocessing.LINKS,
        Preprocessing.NUM,
...
# 1. Config:
        ...
        #Classifier: BERT
# 2. type_task: VALIDATE_MODEL
# 3. DataSet: DataSetDeportistas()
# 4. Classifier: Classification()
#-----------------------------------------------------------------------------------------
def athlete_bert_within_prep():
    config = Configuration([
        ], 
        EncodingMethod.BERT,
        ClassificationMethod.BERT,
...
def athlete_bert_token_stopword_lowercase_lemma():
    config = Configuration([
        Preprocessing.FIX_HASHTAG_TEXT, 
        Preprocessing.REMOVE_STOP_WORDS,
        Preprocessing.LOWERCASE,
...
def athlete_bert_rm_alphanumeric():
    config = Configuration([
        Preprocessing.REMOVE_ALPHA_NUMERIC
    ], 
    EncodingMethod.BERT,
...
def athlete_bert_emoji_link_num_punct():
    config = Configuration([
        Preprocessing.EMOTICONS,
        Preprocessing.LINKS,
        Preprocessing.NUM,
...
# 1. Config:
        ...
        #Classifier: BERT
# 2. type_task: VALIDATE_MODEL
# 3. DataSet: DataSetYoutubers()
# 4. Classifier: Classification()
#-----------------------------------------------------------------------------------------
def youtuber_bert_within_prep():
    config = Configuration([
        ], 
        EncodingMethod.BERT,
        ClassificationMethod.BERT,
...
def youtuber_bert_token_stopword_lowercase_lemma():
    config = Configuration([
        Preprocessing.FIX_HASHTAG_TEXT, 
        Preprocessing.REMOVE_STOP_WORDS,
        Preprocessing.LOWERCASE,
...
def youtuber_bert_rm_alphanumeric():
    config = Configuration([
        Preprocessing.REMOVE_ALPHA_NUMERIC
    ], 
    EncodingMethod.BERT,
...
def youtuber_bert_emoji_link_num_punct():
    config = Configuration([
        Preprocessing.EMOTICONS,
        Preprocessing.LINKS,
        Preprocessing.NUM,
...
def all_bert_token_stopword_lowercase_lemma():
    config = Configuration([
        Preprocessing.FIX_HASHTAG_TEXT, 
        Preprocessing.REMOVE_STOP_WORDS,
        Preprocessing.LOWERCASE,
...
def all_bert_emoji_link_num_punct():
    config = Configuration([
        Preprocessing.EMOTICONS,
        Preprocessing.LINKS,
        Preprocessing.NUM,
